...
const AgentCard = ({ name, description, imageUrl }: AgentCardProps) => {
  ...
  return (
    <>
      <div className="relative lg:w-1/2 xs:w-full flex justify-center items-center gap-3 border rounded-xl px-[32px] py-[24px] bg-[#F5F5F5] max-md:flex-col">
        {/* Cross Button */}
        <button
          className="absolute top-1 right-2 text-gray-500 hover:text-gray-700 focus:outline-none text-[30px]"
        ...
        {/* Share Icon */}
        <Share2
          className="absolute bottom-4 right-4 text-gray-500 hover:text-gray-700 cursor-pointer"
          size={24}
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-6 w-[400px]">
            <h2 className="text-lg font-semibold mb-4">Do you want to delete this?</h2>
          ...
          <div className="bg-white rounded-lg p-6 w-[400px]">
            ...
            <div className="flex justify-around">
              <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                <Facebook className="text-blue-600 hover:text-blue-800" size={32} />
              </a>
              <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
                <Twitter className="text-blue-400 hover:text-blue-600" size={32} />
              </a>
              <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer">
                <Linkedin className="text-blue-700 hover:text-blue-900" size={32} />
              </a>
