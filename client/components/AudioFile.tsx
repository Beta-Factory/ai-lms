const AudioFIle = () => {
    return (
<>
<div className="border w-[200px] p-2 rounded-full flex items-center bg-[#FFA500] gap-2  justify-between">
...
<path d="M5 2.6001L5 16.2001" stroke="#FFA603" stroke-width="2" stroke-linecap="round"/>
<path d="M9 3.80005L9 15" stroke="#FFA603" stroke-width="2" stroke-linecap="round"/>
...
<path d="M17 7L17 11.8" stroke="#FFA603" stroke-width="2" stroke-linecap="round"/>
                    ...
                    <div className="flex flex-col ">
                      ...
                      <span className="text-[#ffffff] text-[10px]">2.3 MB</span>
                    </div>
                  </div>
                  <div>
                    <svg
