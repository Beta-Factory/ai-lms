...
<div className="w-full  ">
  ...
  <div className="lg:w-[500px] xs:w-full  flex justify-center items-center gap-3 border rounded-xl py-8 px-2">
    ...
    <div className="flex flex-col">
      <span className="text-[#000000]">AI Software Engg</span>
      <span className="text-[10px] text-[#808080]">
        Lorem ipsum dolor sit amet consectetur. Libero ipsum quisque ornare erat turpis eu. Integer accumsan euismod ac pellentesque dictumst dolor. Natoque euismod proin vivamus eget tincidunt. Nisi lectus eu mi ligula facilisi pharetra gravida nec morbi.
      </span>
    </div>
  </div>
